...
function renderUserCard(user) {
    ...
    main.innerHTML = `
    <div class="card">
    <a href=${html_url} target="_blank"><img class="profile-img" src=${avatar_url} alt="foto da usuária do github">
  ...
  `
    ...
    repoButton.addEventListener('click', aperteaqui = (e) => {
        e.preventDefault();
        getRepositories(login)
        repoButton.removeEventListener('click', aperteaqui)
