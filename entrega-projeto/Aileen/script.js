...
function renderUserCard(user) {
    ...
    <div class="card">
     ...
     <div class="profile-infos">
      ...
      <div id="repo-botton" class="box-icons">
    ...
    const repoButton = document.getElementById('repo-botton')

    repoButton.addEventListener('click', singleClick = (e) => {
        e.preventDefault()
        getRepositories(login)
        repoButton.removeEventListener('click', singleClick)
    })
}

function renderUserNotFoud() {
    main.innerHTML = `
     <div class="not-found-box">
      <h1 class="not-found-title">404: Usuária não encontrada :(</h1>
      <h3 class="not-found-subtitle">Pesquise novamente</h3>
      <img class="not-found-image" src="../../assets/notfound.png">
     </div>
    `
}
