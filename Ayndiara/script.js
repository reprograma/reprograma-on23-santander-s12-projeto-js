  ...
  repositories.map((repository) => {
    ...
    return repositoriesList.innerHTML += `
      <div class='repository'>
        ...
        <p class='repository-description'>${description == null ? "Este repositório não possui descrição" : description
      }</p>
        <div class='repository-details'>
          <p class='repository-text'>${language == null ? "sem linguagem" : language
      }</p>
